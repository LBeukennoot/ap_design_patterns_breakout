class Slow implements PaddleBehaviour {
    ...
    public move(): void {
        ...
        if(this.paddle.moveLeft)   newX = this.paddle.x - (this.paddle.speed * 0)
        if(this.paddle.moveRight)  newX = this.paddle.x + (this.paddle.speed * 0)
