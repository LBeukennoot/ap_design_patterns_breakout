class Double implements PaddleBehaviour {
    ...
    public move(): void {
        ...
        if(this.paddle.moveLeft)   newX = this.paddle.x - (this.paddle.speed * 2)
        if(this.paddle.moveRight)  newX = this.paddle.x + (this.paddle.speed * 2)
